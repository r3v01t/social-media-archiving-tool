...
export default async function updateAllowedContractInWallet() {
  ...
  const transaction = await contract.updateAllowedContractAddress(
    process.env.WEB_ARCHIVE_CONTRACT_ADDRESS
  );
